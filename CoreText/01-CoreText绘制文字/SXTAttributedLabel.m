...
#import "SXTAttributedLabel+Utils.h"
#import "SXTAttributedLabel+Draw.h"
#import "UIView+frameAdjust.h"

@interface SXTAttributedLabel ()
 ...
 * 选中超文本的数据模型
 */
@property (nonatomic, strong) SXTAttributedLink *selectedLink;

/**
 * 选中图片的数据模型
 */
@property (nonatomic, strong) SXTAttributedImage *selectedImage;

@end

@implementation SXTAttributedLabel
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    SXTAttributedLink *selectedLink = [self touchLinkWithPosition:position];
    ...
    SXTAttributedImage *selectedImage = [self touchContentOffWithPosition:position];
