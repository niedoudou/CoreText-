...
@implementation SXTAttributedLabel (Utils)
@dynamic frameRef;
@dynamic linkArr;
@dynamic imageArr;
...
- (SXTAttributedImage *)touchContentOffWithPosition:(CGPoint)position
{
    ...
    // 3.2获取符合条件的对象
    SXTAttributedImage *imageData = [resultArr firstObject];
 ...
 */
- (SXTAttributedLink *)linkAtIndex:(CFIndex)index
{
    SXTAttributedLink *link = nil;
    
    for (SXTAttributedLink *linkData in self.linkArr) {
