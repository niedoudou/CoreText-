...
@property (strong, nonatomic) SXTAttributedLabel *attributedLabel;
...
- (void)viewDidLoad {
    ...
    self.attributedLabel = [[SXTAttributedLabel alloc] init];
    ...
    [self.attributedLabel setText:@"今日下午，楚天都市报记者@大欢 来到解放公园内的征婚角，悬挂着上百张征婚启事，有很多市民或是帮子女，或是帮朋友找寻合适的对象(找对象上淘宝：www.taobao.com [/haha.gif])。记者找到了严先生觉得很奇葩的征婚[/haqian.gif]启事，在启事择偶要求一栏，征婚者胡先生要求女方“能生男孩”[/haha]。并且，在启事的最后，@胡先生 还说明“#本人爸爸是局长#”"];
