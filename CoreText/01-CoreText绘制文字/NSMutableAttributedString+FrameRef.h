 ...
 * 获取图片的rect
 */
CGRect CTRunGetTypographicBoundsForImageRect(CTRunRef runRef, CTLineRef lineRef, CGPoint lineOrigin, SXTAttributedImage *imageData);
